...
optimizer = "adagrad"          # options:
                            #         adam
                            #         nadam
                            #         SGD
                            #         adagrad

frozen = "unfrozen"           # options:
                            #         frozen
                            #         unfrozen
        
data_choice = "full_aug"

imported_module = "inception"
...
feature_extractor_url  ="/home/s2936860/incep/"
...
with open(path+'training_progress_100epochs_' + imported_module + '_' + optimizer + '_' + frozen + '_' + data_choice+  '.csv', 'w', newline='') as file:
